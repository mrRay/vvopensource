...
///	Only used to support the (non-specification) OSC query protocol.  All queries must be sent via this method (the query has to actually be sent from an input port, or the client won't know what to reply to)
