...
@interface VVBuffer : NSObject <NSCopying> {
	...
	uint64_t			contentTimestamp;	//	set by the buffer pool's class method.  this variable is *NOT* set automatically- its use is entirely optional and up to the implementation
