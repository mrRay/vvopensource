...
- (SyphonImage *) syphonImage	{
	SyphonImage		*syphonImage = ((long)backingID==VVBufferBackID_Syphon) ? backingReleaseCallbackContext : nil;
	return syphonImage;
}
/*
- (void) setSyphonImage:(SyphonImage *)n	{
	SyphonImage		*syphonImage = (descriptor.backingType==VVBufferBack_Syphon) ? backingReleaseCallbackContext : nil;
	VVRELEASE(syphonImage);
	backingReleaseCallback = VVBuffer_ReleaseSyphonImage;
