...
- (void) dealloc	{
	...
	VVLockLock(&propertyLock);
	VVRELEASE(filePath);
	VVRELEASE(fileName);
	VVRELEASE(fileDescription);
	VVRELEASE(fileCredits);
	VVLockUnlock(&propertyLock);
